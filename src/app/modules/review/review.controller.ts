...
const updateReviewIntoDb = catchAsync(async (req, res) => {
    ...
    const review = await ReviewService.updateReviewIntoDb(payload, reviewId, userId, productId);
...
const getReviewBySlugForEachProduct = catchAsync(async (req, res) => {
    ...
    const reviews = await ReviewService.getReviewBySlugForEachProduct(slug, req.query);
